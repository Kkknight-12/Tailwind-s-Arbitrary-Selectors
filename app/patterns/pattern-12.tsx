      ...
      <div className="space-y-6">
        <div className="bg-lime-50 border-2 border-lime-200 rounded-lg p-4">
          ...
          <p className="text-xs text-lime-700 mt-1">
            Styling:{" "}
            <code className="bg-lime-200 px-1 rounded">bg-lime-100</code> (lime
            background) and{" "}
            <code className="bg-lime-200 px-1 rounded">border-lime-400</code>
          </p>
          <p className="text-xs text-lime-700 mt-2 font-semibold">
            Note: <code className="bg-lime-200 px-1 rounded">:not()</code> is a
            negation pseudo-class - excludes matching elements
          </p>
        </div>
